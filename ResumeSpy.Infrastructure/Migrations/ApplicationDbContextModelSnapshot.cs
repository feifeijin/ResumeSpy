...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.PromptTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.AnonymousUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.Resume", b =>
                {
                    ...
                    b.HasIndex("UserId", "AnonymousUserId");
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.ResumeVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ResumeDetailId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.UserIdentity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.Resume", b =>
                {
                    b.HasOne("ResumeSpy.Core.Entities.General.AnonymousUser", "AnonymousUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ResumeSpy.Core.Entities.General.ResumeVersion", b =>
                {
                    b.HasOne("ResumeSpy.Core.Entities.General.ResumeDetail", "ResumeDetail")
                        .WithMany()
