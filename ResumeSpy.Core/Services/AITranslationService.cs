...
{
    /// <summary>
    /// AITranslationService needed for the orchestrator
    /// This class needs to be accessible from Core layer for the orchestrator
    /// </summary>
    internal class AITranslationService : IAITranslationService
    {
        private readonly IGenerativeTextService _textService;

        public AITranslationService(IGenerativeTextService textService)
        {
